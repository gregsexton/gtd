...
(deftest get-offset-unit-relvals-return-correct-unit
  ...
  (is (= Calendar/DATE   (:unit (get-offset "tue"))))
  (is (= Calendar/DATE   (:unit (get-offset "tues"))))
...
(deftest get-offset-value-relvals-return-correct-value
  ...
  (is (= (months-until :january) 
         (:val (get-offset "jan"))))
  (is (= (months-until :february) 
         (:val (get-offset "feb"))))
  (is (= (months-until :january) 
         (:val (get-offset "january"))))
  (is (= (months-until :february) 
         (:val (get-offset "february"))))
  ...
  (is (= 10 (:val (get-offset "10 mins"))))
  (is (= 11 (:val (get-offset "11 mins"))))
  (is (= 20 (:val (get-offset "20 mins"))))
  (is (= 1 (:val (get-offset "1"))))
